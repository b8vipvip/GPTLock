...
- Membership/orders: plan, entitlement dates, order amount/status, payment-method code and HTTPS payment URL; GPTWork does not collect card numbers or payment passwords in the browser extension.
...
- Native Messaging: local communication with the separately installed GPTWork Native Core.
